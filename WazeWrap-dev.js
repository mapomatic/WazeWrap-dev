...
/* *******************************
* !!!IMPORTANT!!!
* This is a combined WazeWrap.js and WazewrapLib.js file, only for development purposes.
********************************* */
...
(function() {
    ...
    const WW_URL = 'https://raw.githubusercontent.com/mapomatic/WazeWrap-dev/master/WazeWrapLib-dev.js'; //'https://cdn.staticaly.com/gh/WazeDev/WazeWrap/master/WazeWrapLib.js?env=dev';
...
function CALL_WW() {
    ...
    async function init() {
        ...
        WazeWrap.Version = "2023.03.29.01";
